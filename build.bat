...
set "COMMON_SOURCES=src\dictionary.c src\dictionary_stack.c src\format.c src\gemini_pr.c src\keymap.c src\orthography.c src\phrasing.c src\raw_serial.c src\retro.c src\runtime_config.c src\stentura.c src\steno.c src\steno_stroke.c src\stroke_merge.c src\stb_ds_impl.c src\stitch.c src\text_util.c src\translation_history.c src\translation_match.c src\tx_bolt.c src\tx_bolt_multiple.c src\util.c src\platform_windows.c"
