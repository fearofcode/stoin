...
| SKPR | nobody | third_singular |
| SKPW | nothing | third_singular |
...
| STPH | not | third_singular |
| R | or | third_singular |
| SH | so | third_singular |
| WHR | when | third_singular |
| STH | then | third_singular |
| SHR | how | third_singular |
| TH | to | third_singular |
| TPHR | from | third_singular |
| PWH | without | third_singular |
| STPHR | nor | third_singular |
| SPWH | because | third_singular |
...
| Present stroke | Past stroke | Verb | Suffix |
| --- | --- | --- | --- |
| ∅ | -D | ∅ | ∅ |
| -B | -BD | be | ∅ |
| -BT | -BTD | be | a |
...
| -BGT | -BGTD | come | to |
| -BL | -BLD | believe | ∅ |
| -BLT | -BLTD | believe | that |
| -RPBG | -RPBGD | become | ∅ |
| -RPBGT | -RPBGTD | become | a |
| -R | -RD | run | ∅ |
| -RPBL | -RPBLD | make | ∅ |
| -RPBLT | -RPBLTD | make | a |
| -RBT | -RBTD | take | ∅ |
...
| --- | --- |
| Shared FV / NV starter | Shared IV / NV tail |
