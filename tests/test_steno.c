...
int main(void)
{
    ...
    const struct {
        ...
        { "SKPWH*U-G", "and don't go" },
        { "SKPWHA-G", "and can go" },
        { "SKPWHE-G", "and are going" },
        { "SKPWH-FG", "and have gone" },
        { "SKPWHE-FG", "and have been going" },
    };
