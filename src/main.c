...
{
    fputs("usage: stoin [--config PATH] [--dictionary PATH ...]\n", stderr);
    ...
    fputs("       stoin [--config PATH] [--dictionary PATH ...] --lookup STROKE\n", stderr);
    fputs("       stoin [--config PATH] [--dictionary PATH ...] --dump-dictionary [OUTPUT_PATH]\n", stderr);
}
